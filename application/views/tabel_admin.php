                ...
                <div class="post-preview">
                    <h2 style="text-align: center">
					   ...
					   <tr>
						  ...
						  <td style="text-align: center"><?php echo $d['password']; ?></td>
					   </tr>
					   <?php }?>
					   </table>
                        </div>
					...
					<?php foreach($barang as $d){ ?>
						<tr>
							...
							<td align="center" style="height: 125px; width: 125px "><img src="<?php echo base_url("/upload/".$d['foto']).".jpg"; ?>" width="100PX" height="100PX"></td>
